...
function RecentProducts(){
    return (
        <div className={styles.recentProducts}>
            <div className={styles.recentProducts__title}>Explore the recent products</div>
            <div className={styles.recentProducts__subtitle}>
                Our delectable drink options, including classic espresso choices, house specialties,
                fruit smoothies and frozen treats
            </div>

            <div className={styles.recentProducts__cards}>
